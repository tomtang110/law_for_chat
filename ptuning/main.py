...
def main():
  ...
  training_args.generation_max_length = (
      training_args.generation_max_length if training_args.generation_max_length
      is not None else data_args.val_max_target_length
  )
  training_args.generation_num_beams = (
      data_args.num_beams
      if data_args.num_beams is not None else training_args.generation_num_beams
  )
  ...
  if training_args.do_predict:
    ...
    max_predict_samples = (
        ...
        if data_args.max_predict_samples is not None else len(predict_dataset)
    )
